...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h1>THANK YOU!</h1>
            <div class="policy">
                <h1>Section B for cin:<?php if (isset($_SESSION['cin'])) echo("(CIN: $cin)"); else echo("")?> Successfully Printed.</h1>
            </div>
        </div>
        <script>
            /* ************************************************************************************************************************************ */
                    ...
                    <table>
                        ...
                        <?php
                            ...
                            foreach ($limited_t_gre as $index => $rowData) {
                                ...
                                if ($index == 1) {
                                    echo '<td style="text-align: left;">Performance against above policies and follow up action</td>';
                                } else{
                                    echo '<td style="text-align: left;">Compliance with statutory requirements of relevance to the principles, and, rectification of any non-compliances</td>';
                                }                                
                                // Fetch data
                                foreach ($rowData as $columnData) {
                                    echo '<td>' . $columnData . '</td>';
