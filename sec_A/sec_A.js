...
/* ************************************************************************************************************************************ */
    ...
    pucInput.addEventListener("input", function () {
        ...
        var uomRegex = /^(Rs\.?|Rs-?|Rs)?\s*((\d+(,\d{2})*(,\d{1,3})*(\.\d+)?|\d+(\.\d+)?))\s*(Hundred|Thousand|Lakh|Crore|Million|Billion|Trillion|Hundreds|Thousands|Lakhs|Crores|Millions|Billions|Trillions)wa$/i;
