...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h1>THANK YOU!</h1>
            <div class="policy">
                <h1>Section A for cin:<?php if (isset($_SESSION['cin'])) echo("(CIN: $cin)"); else echo("")?> Successfully Printed.</h1>
            </div>
        </div>
        <script>
            /* ************************************************************************************************************************************ */
            ...
            <?php
                ...
                echo "const incorpDate = " . json_encode($row['incorp_date']) . ";\n";
            ...
            function generatePDF() {
                    ...
                    ol: [
                        ...
                        //3-Year of incorporation
                        {
                            columns: [
                                ...
                                { text: incorpDate, alignment: 'left', margin: [10, 0, 10, 10] }
                            ]
                        },
                    ...
                    ol: [
                        {
                            columns: [
                                ...
                                { text: rep_b, alignment: 'left', margin: [10, 0, 10, 10] }
                            ]
                        },
                    ],
                    start: 13
                ...
                const filename = `${name}_BRSR_${reporting_fin_year}.pdf`;
                const pdfDefinition = {
