...
<body>
    ...
    <div class="container">
        <form method="post" action="sec_B_response.php" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="policy">
                    <label for="directorStatement" class="form-label">Statement by director responsible for the business responsibility report, highlighting Environmental, Social, Governance(ESG) related challenges, targets & achievements:</label>
                </div>
            ...
            <div class="mb-3">
                <div class="policy">
                    <label for="achievementsQuestion" class="form-label">Achievements (Upload PDF only - Max size 5 MB)</label>
                </div>
