                            ...
                            <div id="returnRetentionRates" class="responsive-table">
                                <table id="p_returnRetentionRates">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 2)"></td>
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 2)"></td>
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 2)"></td>
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 2)"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 3)"></td>
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 3)"></td>
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 3)"></td>
                                        <td><input type="number" id="returnRetentionRates" name="returnRetentionRates[]" class="form-control" oninput="calculatetotals5('p_returnRetentionRates', 3)"></td>
                                    </tr>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="invisible_container">
                                ...
                                <div class="mb-3-sub-last">
                                    ...
                                    <textarea id="dataBreachesInfoPercentage" name="dataBreachesInfoPercentage" class="form-control" placeholder="Enter the details" required></textarea>
                                </div>
                            </div>
                        </div>
                        <!--Data breaches end-->
