    ...
    <div class="container">
        <form method="post" enctype="multipart/form-data">
            ...
            <div id="prin1" class="prin-div" style="display:block;">
                ...
                <button class="btn-primary" onclick="navigate(1)">Next</button>
            </div>
            ...
            <div id="prin2" class="prin-div">
                ...
                <button class="btn-primary" onclick="navigate(-1)">Previous</button>
                <button class="btn-primary" onclick="navigate(1)">Next</button>
            </div>
            ...
            <div id="prin3" class="prin-div">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="unionMembershipPercentage" name="unionMembershipPercentage" class="form-control" placeholder="Enter the percentage" required>
                </div>
                <div class="mb-3">
                    <div class="policy">
            ...
            <div id="prin9" class="prin-div">
                ...
                <button class="btn-primary" onclick="navigate(-1)">Previous</button>
                <button class="btn-primary" type="submit" onclick="return submitForm();">Submit</button>
            </div>
        </form>
    </div>
