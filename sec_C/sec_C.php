            ...
            <form method="post"  id="myForm" action="" enctype="multipart/form-data" novalidate>
                ...
                <div id="prin2" class="prin-div">
                    ...
                    <div class="bold_border_container">
                        ...
                        <div class="mb-3">
                            <div class="policy">
                                <label for="sustainableSourcing2" class="form-label"><span style="color: red;"> * </span>2. Does the entity have procedures in place for sustainable sourcing? (Yes/No). Enter the details:</label>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3 invisible_container">
                                ...
                                <div id="lifeInsuranceCompensationdetailsa" class="mb-3 hidden">
                                    <div class="policy">
                                        <label for="lifeInsuranceCompensationdetailsa" class="form-label">Enter Details:</label>
                                    </div>
                                ...
                                <div id="lifeInsuranceCompensationdetailsb" class="mb-3 hidden">
                                    <div class="policy">
                                        <label for="lifeInsuranceCompensationdetailsb" class="form-label">Enter Details:</label>
                                    </div>
